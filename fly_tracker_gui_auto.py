...
class Ui_FlyTracker(object):
    def setupUi(self, FlyTracker):
        ...
        self.syringe_size_box.setProperty("value", 50.0)
        ...
        self.num_trials_box.setProperty("value", 100)
        ...
        self.flush_box.setProperty("value", 3.0)
        ...
        self.trial_period_box.setProperty("value", 5.0)
        ...
        self.using2p_toggle.setChecked(False)
        self.using2p_toggle.setAutoExclusive(False)
        ...
        self.using_optostim_toggle_2 = QtWidgets.QRadioButton(self.centralwidget)
        self.using_optostim_toggle_2.setGeometry(QtCore.QRect(330, 640, 116, 22))
        self.using_optostim_toggle_2.setChecked(True)
        self.using_optostim_toggle_2.setAutoExclusive(False)
        self.using_optostim_toggle_2.setObjectName("using_optostim_toggle_2")
    ...
    def retranslateUi(self, FlyTracker):
        ...
        self.stim_type.setItemText(5, _translate("FlyTracker", "Left_Odor"))
        self.stim_type.setItemText(6, _translate("FlyTracker", "Right_Odor"))
        self.stim_type.setItemText(7, _translate("FlyTracker", "Left_Air"))
        self.stim_type.setItemText(8, _translate("FlyTracker", "Right_Air"))
        self.stim_type.setItemText(9, _translate("FlyTracker", "Both_Air_Rev"))
        self.stim_type.setItemText(10, _translate("FlyTracker", "Left_Air_Rev"))
        self.stim_type.setItemText(11, _translate("FlyTracker", "Right_Air_Rev"))
        ...
        self.using_optostim_toggle_2.setText(_translate("FlyTracker", "Opto-stim"))
